...
namespace MV2VideoRecorder
{
    public partial class MainPage : ContentPage
    {
        ...
        private async void btnSalvar_Clicked(object sender, EventArgs e)
        {
            ...
            {
                await DisplayAlert("Alerta", "El campo 'Descripción' no debe quedar vacio", "OK");
            ...
            else
            {
                ...
                if (resultado == 1)
                {
                    await DisplayAlert("", "Video guardado exitosamente!", "OK");
                    txtdescripcion.Text = "";
                    videoPlayer.Source = null;
                }
                else
                {
                    await DisplayAlert("Error", "El video no se pudo guardar", "OK");
                }
            }
        }
